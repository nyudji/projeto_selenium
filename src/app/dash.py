...
def display_dash2():
    ...
    def get_data():
        try:
            ...
            path_parquet = os.path.join(base_dir, 'dados', 'tratado', 'parquet', 'dados_tratado.parquet')
            df_todos = pd.read_parquet(path_parquet)
            return df_todos
        except FileNotFoundError:
            st.error("Arquivo de dados não encontrado. Verifique se o arquivo existe na pasta 'dados/tratado/parquet'.")
            return None
